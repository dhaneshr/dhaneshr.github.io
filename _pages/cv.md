...
* **Aug 2023 &ndash; Present: Applied Machine Learning Scientist &mdash; Health Lead**
  ...
  * Technical lead for an ultrasound lymph-node detection/segmentation project (HealthSpark:Tenomix): extended a 2D object detection model to a 2.5D volumetric pipeline and applied positive-unlabeled learning to address limited ground truth.
  * Scientific advisor for a clinical Text-to-SQL system (HealthSpark:Verto Health): conducted cohort evaluation and literature review, and built a reference LightRAG-based implementation adopted by the delivery team.
  * Scientific advisor for surgeme classification and needle tracking project (HealthSpark:Revolve Surgical): building a model of action classification for surgical video and tracking needle-keypoints for robot-assisted surgery.
