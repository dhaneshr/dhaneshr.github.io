...
* **Aug 2023 &ndash; Present: Applied Machine Learning Scientist &mdash; Health Lead**
  ...
  * Designed **CRISPNAM-FG**, an intrinsically interpretable Fine-Gray competing-risks deep survival model, to flag diabetic patients at high risk of post-discharge foot complications; built on a retrospective cohort of 107,000+ patients across 29 Ontario hospitals (GEMINI database).
  * Led an end-to-end document data-extraction pipeline for the Ontario Long Term Care Association, combining Python-based document parsers with LLM- and OCR-based extraction methods to structure 37,000+ Ontario long-term-care inspection reports into a query-able dataset at &ge;90% target accuracy; delivered the codebase, searchable database, technical report and handoff.
  ...
  * Scientific advisor for an LLM-based classification system for long-context clinical conversations at a mental health hospital, advising on deployment infrastructure, data security, licensing, labeling tooling and data readiness.
  * Technical lead for an ultrasound lymph-node detection/segmentation project with a Canadian health-tech startup: extended a 2D object detection model to a 2.5D volumetric pipeline and applied positive-unlabeled learning to address limited ground truth.
  * Scientific advisor for a clinical Text-to-SQL system with a Canadian health-tech startup: conducted cohort evaluation and literature review, and built a reference LightRAG-based implementation adopted by the delivery team.
  * Scientific advisor for a surgeme classification and needle tracking project with a Canadian robotic-surgery startup: building a model of action classification for surgical video and tracking needle-keypoints for robot-assisted surgery.
